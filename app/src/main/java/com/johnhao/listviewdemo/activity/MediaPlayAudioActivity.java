...
public class MediaPlayAudioActivity extends BaseActivity implements View.OnClickListener{
    ...
    private Button audio_play;
    private Button audio_pause;
    private Button audio_stop;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Play Audio");
        audio_play = findViewById(R.id.btn_media_audio_play);
        audio_pause = findViewById(R.id.btn_media_audio_pause);
        audio_stop = findViewById(R.id.btn_media_audio_stop);
